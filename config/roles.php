...
return [
    ...
    */
    ...
    'roleUserTable'         => 'users_vs_roles',
    'permissionsTable'      => 'users_permissions',
    'permissionsRoleTable'  => 'users_permissions_vs_roles',
    'permissionsUserTable'  => 'users_vs_permissions',
    ...
    */
    ...
    'models' => [
        'role'          => env('ROLES_DEFAULT_ROLE_MODEL', App\Modules\User\Models\Role::class),
        'permission'    => env('ROLES_DEFAULT_PERMISSION_MODEL', App\Modules\User\Models\Permission::class),
