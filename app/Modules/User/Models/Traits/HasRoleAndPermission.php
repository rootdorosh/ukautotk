...
trait HasRoleAndPermission
{
    ...
    public function rolePermissions()
    {
        ...
        return $permissionModel
            ::select(['users_permissions.*', 'users_permissions_vs_roles.created_at as pivot_created_at', 'users_permissions_vs_roles.updated_at as pivot_updated_at'])
            ->join('users_permissions_vs_roles', 'users_permissions_vs_roles.permission_id', '=', 'users_permissions.id')
            ->join('users_roles', 'users_roles.id', '=', 'users_permissions_vs_roles.role_id')
            ->whereIn('users_roles.id', $this->getRoles()->pluck('id')->toArray())
            ->orWhere('users_roles.level', '<', $this->level())
            ->groupBy(['users_permissions.id', 'users_permissions.name', 'users_permissions.slug', 'users_permissions.description', 'users_permissions.model', 'users_permissions.created_at', 'users_permissions.updated_at', 'users_permissions.deleted_at', 'pivot_created_at', 'pivot_updated_at']);
    }
    ...
    {
        return $this->rolePermissions()->get();
    }
